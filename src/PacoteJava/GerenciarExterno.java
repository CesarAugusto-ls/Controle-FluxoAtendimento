 ...
 * @author cesilva
 */
public class GerenciarExterno extends javax.swing.JFrame {

    /**
     * Creates new form InserirNoExterno
     */
    public GerenciarExterno() {
        initComponents();
        
        for (int i = 0; i < Main.AtendimentoExterno.size(); i++) {

            Funcionarios fun = Main.AtendimentoExterno.get(i);
            ...
            DefaultTableModel model = (DefaultTableModel) jTabelaExterno.getModel();
            model.addRow(dados);
        }
    ...
    private void initComponents() {
        ...
        jTabelaExterno = new javax.swing.JTable();
        jLabel1 = new javax.swing.JLabel();
        jButton2 = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Inserir Usuario no Externo");
        ...
        jTabelaExterno.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jTabelaExterno);

        jLabel1.setText("Usuarios Atuais no Externo:");
        ...
        if (!id.equalsIgnoreCase("")) {
            ...
            if (existeusuario == 1) {
                ...
                if (verificacao == 0) {
                    ...
                    for (int i = 0; i < Main.Funcionarios.size(); i++) {
                        if (ID == Main.Funcionarios.get(i).getID()) {
                            funexterno.setID(Main.Funcionarios.get(i).getID());
                            funexterno.setNome(Main.Funcionarios.get(i).getNome());
                            funexterno.setHorEntrada(Main.Funcionarios.get(i).getHorEntrada());
                            funexterno.setHorSaida(Main.Funcionarios.get(i).getHorSaida());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (!id.equalsIgnoreCase("")) {
            ...
            if (existeusuario == 1) {
                ...
                dispose();
                GerenciarExterno RemExterno = new GerenciarExterno();
                RemExterno.setVisible(true);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GerenciarExterno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GerenciarExterno().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable jTabelaExterno;
